...
/*		int temp = 1;
		...
		for(int i = 0;i <= 6;i = i + 2){
			vo.matchrecord[i] = po.getTeamScores()[i / 2];
		}
		
		vo.matchrecord[1] = po.getTeamScores()[4];
		vo.matchrecord[3] = po.getTeamScores()[5];
		vo.matchrecord[5] = po.getTeamScores()[6];
		vo.matchrecord[7] = po.getTeamScores()[7];
		return vo;
	}
