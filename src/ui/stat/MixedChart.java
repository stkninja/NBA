...
public class MixedChart {
	...
	public void chart1() throws IOException { 
		...
		standardChartTheme.setLargeFont(new Font("宋体",Font.PLAIN, 12));//可以改变轴向的字体
		standardChartTheme.setRegularFont(new Font("宋体",Font.PLAIN, 12));//可以改变图例的字体
		standardChartTheme.setExtraLargeFont(new Font("宋体",Font.PLAIN, 12));//可以改变图标的标题字体
		...
		chart.getTitle().setFont(new Font("宋体", Font.BOLD, 13));//设置title标题
		chart.setBackgroundPaint(new Color(238, 238, 255));//设置背景色
		chart.getLegend().setItemFont(new Font("宋体", Font.PLAIN, 11));// 底部
		...
		valueAxis.setLabelFont(new Font("黑体", Font.PLAIN, 11)); // 设置数据字体(纵轴)
		CategoryAxis categoryaxis = categoryplot.getDomainAxis();
		categoryaxis.setLabelFont(new Font("黑体", Font.PLAIN, 11)); // 设置时字体（横轴）
