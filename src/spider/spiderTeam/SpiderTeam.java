...
public class SpiderTeam {
	static String[][] teamInfo = 
		   {{"Atlanta Hawks", "ATL", "", "", "", "Atlanta", "E", "Southeast", "Philips Arena", "1949"},
			{"Brooklyn Nets", "BRK", "New Jersey Nets", "NJN", "", "Brooklyn", "E", "Atlantic", "Barclays Center", "1976"},
			...
			{"New Orleans Pelicans", "NOP", "New Orleans Hornets", "NOH", "NOK", "New Orleans", "W", "Southwest", "Smoothie King Arena", "2002"},
			...
			{"Phoenix Suns", "PHO", "", "PHX", "", "Phoenix", "W", "Pacific", "US Airways Center", "1968"},
	...
	public static ArrayList<TeamBasicStruct> spiderTeam() {
		...
		for(int i = 0; i < 30; i++){
			...
			teamBasicStruct.setHistoryAbblName2(teamInfo[i][4]);
			teamBasicStruct.setLocation(teamInfo[i][5]);
			teamBasicStruct.setCompetionArea(teamInfo[i][6]);
			teamBasicStruct.setSubArea(teamInfo[i][7]);
			teamBasicStruct.setHomeGround(teamInfo[i][8]);
			teamBasicStruct.setSetupTime(teamInfo[i][9]);
